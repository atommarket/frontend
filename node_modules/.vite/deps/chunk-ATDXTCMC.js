...
var ICONS = {
  add: async () => (await import("./add-CKKAXNX2.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-RVUG6CMK.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-LMB4YJ5D.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-DYI3AWL7.js")).appStoreSvg,
  apple: async () => (await import("./apple-GEHPIOWZ.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-OEFAN2XD.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-FGTA5QUA.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-UB55XJDX.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-LKUIHEJ5.js")).arrowTopSvg,
  bank: async () => (await import("./bank-6YFC5Q3E.js")).bankSvg,
  browser: async () => (await import("./browser-PH2LTNZO.js")).browserSvg,
  card: async () => (await import("./card-T77KFUC5.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-CP6IWH6Z.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-TG5N5JCY.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-EHVPUCA6.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-OBCQOB2A.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-AVNPAZC7.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-ND2OOIML.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-KSBUMESL.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-Q2XNZTNN.js")).clockSvg,
  close: async () => (await import("./close-QL4MYIPW.js")).closeSvg,
  compass: async () => (await import("./compass-3M7ARH7T.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-X74YWZZM.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-N2P4OG3O.js")).copySvg,
  cursor: async () => (await import("./cursor-ZYROKPNG.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-NWI7HCNP.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-4ILG5EPN.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-HRQFOQMH.js")).disconnectSvg,
  discord: async () => (await import("./discord-AX2LZXTH.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-VDCGUMSZ.js")).etherscanSvg,
  extension: async () => (await import("./extension-BJ7JASZD.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-RHYGTDMY.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-DGSSU7BQ.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-I3K2E5FA.js")).farcasterSvg,
  filters: async () => (await import("./filters-NZPA3FCS.js")).filtersSvg,
  github: async () => (await import("./github-TIMCYDPN.js")).githubSvg,
  google: async () => (await import("./google-QIGSBL2U.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-OS4JW2YF.js")).helpCircleSvg,
  image: async () => (await import("./image-NLYFT6DT.js")).imageSvg,
  id: async () => (await import("./id-HXAEN5WM.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-UZALX3VC.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-NN2OQNPZ.js")).lightbulbSvg,
  mail: async () => (await import("./mail-3IV2RV7A.js")).mailSvg,
  mobile: async () => (await import("./mobile-IY2LBFVA.js")).mobileSvg,
  more: async () => (await import("./more-ILFN3BS4.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-HC4WPPNB.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-HWMWZNER.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-EYM6QG3H.js")).offSvg,
  playStore: async () => (await import("./play-store-6RCWBEQP.js")).playStoreSvg,
  plus: async () => (await import("./plus-Z4H54LEZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-X5KKBM7E.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-ETUY6RZH.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-FYMBWLRF.js")).refreshSvg,
  search: async () => (await import("./search-COJACVTS.js")).searchSvg,
  send: async () => (await import("./send-X4WAWVQD.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-5V3266L5.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-GNTCW4FR.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-NHP34AYK.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-JDLMTR5I.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-VPNALOU2.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-RZFSHR3E.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-LPLFXLBY.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-CNMSD734.js")).twitchSvg,
  twitter: async () => (await import("./x-KYN73YUC.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-LEXS7CHW.js")).twitterIconSvg,
  verify: async () => (await import("./verify-Z6KNGRYI.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-4RONGX6P.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-LPRYE27J.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-4M4BZBGP.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-4M4BZBGP.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-4M4BZBGP.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-3EYPDMGT.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-VMU2AXZ4.js")).warningCircleSvg,
  x: async () => (await import("./x-KYN73YUC.js")).xSvg,
  info: async () => (await import("./info-WYXBOFO7.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-URSXGV5J.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-IQWK6CSN.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ATDXTCMC.js.map
