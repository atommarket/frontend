...
var ICONS = {
  add: async () => (await import("./add-G627OJYC.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-MQF4SY7Z.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-DLL46WFQ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-FP7OAKLB.js")).appStoreSvg,
  apple: async () => (await import("./apple-UYYGO3FH.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-3CPR2LDD.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-GCOETA65.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-2ODRO5FI.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-Y7YFX6UO.js")).arrowTopSvg,
  bank: async () => (await import("./bank-SK6OT56D.js")).bankSvg,
  browser: async () => (await import("./browser-YGB7RKJG.js")).browserSvg,
  card: async () => (await import("./card-ID5Q7JIA.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-SXGBQDLC.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-XUS7MZDX.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-UREJAGZQ.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-CFZICQEI.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-7MM5MRGB.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-6GGBY6AT.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-TJR5UTBL.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-4ZM4TZSB.js")).clockSvg,
  close: async () => (await import("./close-JTI5SXXO.js")).closeSvg,
  compass: async () => (await import("./compass-KWSNGYXM.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-H2K6D64H.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-XZPEYJQM.js")).copySvg,
  cursor: async () => (await import("./cursor-YXY75OHO.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-3VAVGDWQ.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-HFOBOMOX.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-VMBAQXKL.js")).disconnectSvg,
  discord: async () => (await import("./discord-65X72UNK.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-ELRVRTLU.js")).etherscanSvg,
  extension: async () => (await import("./extension-QTC5FO22.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-GFTVAFKL.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-AXGEJKEY.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-7RHUBEMU.js")).farcasterSvg,
  filters: async () => (await import("./filters-TB7APKEZ.js")).filtersSvg,
  github: async () => (await import("./github-6VCWCSWA.js")).githubSvg,
  google: async () => (await import("./google-OEKH64P4.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-L6XSCPTG.js")).helpCircleSvg,
  image: async () => (await import("./image-7I3I75I7.js")).imageSvg,
  id: async () => (await import("./id-A637JSUU.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-YL6NR7KB.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-56ZSHK3S.js")).lightbulbSvg,
  mail: async () => (await import("./mail-NSAGR4KH.js")).mailSvg,
  mobile: async () => (await import("./mobile-6ZMRFNS6.js")).mobileSvg,
  more: async () => (await import("./more-PVUUB6TH.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-KNAYCWLD.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-RUJEQKNI.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-CVZJCFON.js")).offSvg,
  playStore: async () => (await import("./play-store-R6B2S63I.js")).playStoreSvg,
  plus: async () => (await import("./plus-JB3UZAMB.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-PJTAO6MD.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-WEFLRQO7.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-MJGNSCXO.js")).refreshSvg,
  search: async () => (await import("./search-BIN45LFP.js")).searchSvg,
  send: async () => (await import("./send-5BXK5UCW.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-VYBB6TZK.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-PARRFYKT.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-RKJZ7DRS.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-E5HWD5BW.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-HVTKOB74.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-V3Z5YO2A.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-GPRX6BRJ.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-JGFOPOIY.js")).twitchSvg,
  twitter: async () => (await import("./x-5ZMZMXBD.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-25SEY5PS.js")).twitterIconSvg,
  verify: async () => (await import("./verify-RXURT4WP.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-QCAXTGCG.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-7DPGYLRX.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-HI5JLVBI.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-HI5JLVBI.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-HI5JLVBI.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-4KUPFLGP.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-GJCKQ546.js")).warningCircleSvg,
  x: async () => (await import("./x-5ZMZMXBD.js")).xSvg,
  info: async () => (await import("./info-O3L6HDBE.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-3HAHPHO5.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-E4ILDCHM.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5CSUAWUX.js.map
