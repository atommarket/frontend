  ...
  "node_modules/iso-url/src/url-browser.js"(exports, module) {
    ...
    var URLWithLegacySupport = class {
      constructor(url2 = "", base4 = defaultBase) {
        this.super = new URL2(url2, base4);
...
var _a2, _string, _tuples, _stringTuples, _path;
var _Multiaddr = class _Multiaddr {
  ...
  tuples() {
    return __privateGet(this, _tuples).map(([code2, value]) => {
      if (value == null) {
        return [code2];
      }
      return [code2, value];
  ...
  stringTuples() {
    return __privateGet(this, _stringTuples).map(([code2, value]) => {
      if (value == null) {
        return [code2];
      }
      return [code2, value];
...
function convertToString2(input) {
  if (input instanceof Uint8Array) {
    return toString2(input, "base58btc");
  }
  if (isString(input)) {
    return input;
  }
...
//# sourceMappingURL=src-HRFIECQN.js.map
