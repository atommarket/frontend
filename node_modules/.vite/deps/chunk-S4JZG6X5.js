...
var ICONS = {
  add: async () => (await import("./add-FBWAF3VV.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-ZEMNCACM.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-C65V3IC7.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-AIW6LLHJ.js")).appStoreSvg,
  apple: async () => (await import("./apple-32VSGWQN.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-6TP7REZN.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-YQBF5YDD.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-XO55GJZO.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-DCUH6X64.js")).arrowTopSvg,
  bank: async () => (await import("./bank-AJ4YPZWE.js")).bankSvg,
  browser: async () => (await import("./browser-VAENILOB.js")).browserSvg,
  card: async () => (await import("./card-SBNASYYO.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-6NSD4TNU.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-PU2S7OSL.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-BNUSPGO6.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-2XKYUOCH.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-LDUPC2TB.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-L2RSKIKO.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-5XL4FHQ6.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-K3YHCXTM.js")).clockSvg,
  close: async () => (await import("./close-JY3WM6ET.js")).closeSvg,
  compass: async () => (await import("./compass-Q57KJ6QQ.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-PSJ5ACU4.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-O2QRDRSF.js")).copySvg,
  cursor: async () => (await import("./cursor-U2C3UYRP.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-AAHGEIYW.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-E52ERCWO.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-SP255XWV.js")).disconnectSvg,
  discord: async () => (await import("./discord-Q7VLWKCO.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-DOZPHIZ5.js")).etherscanSvg,
  extension: async () => (await import("./extension-BOHWXXK2.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-ZLAPTUJC.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-XWQZSP7T.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-UEGPTZLW.js")).farcasterSvg,
  filters: async () => (await import("./filters-6D2KJMFJ.js")).filtersSvg,
  github: async () => (await import("./github-X7XB7EAW.js")).githubSvg,
  google: async () => (await import("./google-BBF3YI5X.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-DXULF3PF.js")).helpCircleSvg,
  image: async () => (await import("./image-54GFRHF5.js")).imageSvg,
  id: async () => (await import("./id-YZB4GK44.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-C7MCDCKC.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-6YCUMOWI.js")).lightbulbSvg,
  mail: async () => (await import("./mail-AKH6K67U.js")).mailSvg,
  mobile: async () => (await import("./mobile-5IKD67DZ.js")).mobileSvg,
  more: async () => (await import("./more-46SI6DHW.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-F767NKZX.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-5V4XFK35.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-3HPOJP6A.js")).offSvg,
  playStore: async () => (await import("./play-store-MZPG5UCU.js")).playStoreSvg,
  plus: async () => (await import("./plus-TTNVEKMQ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-5BKIE76N.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-HY4PTERD.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-FHVIKR7H.js")).refreshSvg,
  search: async () => (await import("./search-PN6NAOT3.js")).searchSvg,
  send: async () => (await import("./send-PNCZNIGS.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-REDUTCSY.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-NVLPHDEL.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-KI4BQ2WA.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-K66PL5EV.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-R3IKQSAD.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-LAGE453J.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-FWBVU2JV.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-RIJVB3FP.js")).twitchSvg,
  twitter: async () => (await import("./x-ZX5OXEBV.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-WB2Q7SYQ.js")).twitterIconSvg,
  verify: async () => (await import("./verify-WKRW45Q3.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-BFTZJTFJ.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-GTMR3R2U.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-BOKCOZAI.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-BOKCOZAI.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-BOKCOZAI.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-Q5BZJORU.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-3ISBH34B.js")).warningCircleSvg,
  x: async () => (await import("./x-ZX5OXEBV.js")).xSvg,
  info: async () => (await import("./info-NFWM443U.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-OPZBLLOM.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-Z656W5GX.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-S4JZG6X5.js.map
